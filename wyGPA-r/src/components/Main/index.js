...
class Main extends Component {
  ...
  handleAddCompCourse = (e)=>{
    ...
    this.props.dispatch(actions.addCompCourse(
      {
        name: name,
        mark: Number(mark),
  ...
  handleAddCurrentCourse = (e)=>{
    ...
    this.props.dispatch(actions.addCurrCourse(
      {
        name: cc_name,
    ...
    return (
      <div className="App">
        ...
        <Link to="/current-course">
          <Button color="info" size="sm"> Current Courses </Button>
        </Link>
        ...
        <form onSubmit={ this.handleAddCurrentCourse.bind(this) }>
          <section>
          Course Name
            <input type="text" name="cc_name" value={this.state.cc_name}  onChange={this.handleChange} placeholder="Course Name"/>
          </section>
          <section>
            Course Weight
            <input type="text" name="cc_weight" value={this.state.cc_weight} onChange={this.handleChange} placeholder="Course Weight"/>
          </section>
          <Button type="submit" size="sm" color="info"> Add Current Course </Button>
        </form>

        <ItemList items={this.props.state.courses.currCourses}
          deleteItem={this.handleDelCourse} type="current"
        ...
        <form onSubmit={ this.handleAddCompCourse.bind(this) }>
          <section>
          Course Name
            <input type="text" name="name" value={this.state.name} onChange={this.handleChange} placeholder="Course Name"/>
          </section>
          <section>
            Course Weight
            <input type="text" name="weight" value={this.state.weight} onChange={this.handleChange} placeholder="Course Weight"/>
          </section>
          <section>
            Final Mark
            <input type="text" name="mark" value={this.state.mark} onChange={this.handleChange} placeholder="Final Course Mark"/>
          </section>
          <Button type="submit" size="sm" color="info"> Add Completed Course </Button>
        </form>

        <ItemList items={this.props.state.courses.compCourses}
          deleteItem={this.handleDelCourse} type="completed"/>

        <div>
          <Average items={this.props.state.courses.compCourses}
