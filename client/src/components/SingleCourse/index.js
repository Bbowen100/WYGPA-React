  ...
  render() {
    ...
    return (
      <div className="App">
          ...
          <h1>Course: { this.props.state.courses.currCourse.name }</h1>
          <form onSubmit={ this.handleAddCurrCrsEval.bind(this) }>
            <section>
            Evaluation Name
              <input type="text" name="name" value={this.state.name} placeholder="Eval Name" onChange={this.handleChange} />
            </section>
            <section>
              Evaluation Weight
              <input type="text" name="weight" value={this.state.weight} placeholder="Eval Weight" onChange={this.handleChange} />
            </section>
            <section>
              Evaluation Mark
              <input type="text" name="mark" value={this.state.mark} placeholder="Eval Mark" onChange={this.handleChange} />
            </section>
            <Button type="submit" size="sm" color="info"> Add Completed Evalution </Button>
          </form>

          <div>
            <ItemList items={this.props.state.courses.currCourse.evals}
              deleteItem={this.deleteEvalHandler}/>
          </div>

          <div className="block">
            <div>
              <Average items={this.props.state.courses.currCourse.evals}
